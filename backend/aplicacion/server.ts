...
export class Server {
    ...
    private configurarRutas(): void {
        ...
        this.app.use('/api/operaciones', crearRutasOperaciones(this.operacionesController));
    ...
    public iniciar(puerto: number): void {
        this.app.listen(puerto, () => {
            ...
            console.log(`🔗 API REST Equipos: http://localhost:${puerto}/api/equipos`);
            console.log(`🔗 API REST Operaciones: http://localhost:${puerto}/api/operaciones`);
