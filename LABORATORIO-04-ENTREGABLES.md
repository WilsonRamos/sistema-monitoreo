...
- ✅ 34 pruebas unitarias de dominio
- ✅ 24 pruebas de integración con repository
- ✅ 16 pruebas de integración con mocks
- ✅ 82 pruebas totales - 100% pasadas
...
- Excavadora.ts: 100%
- Volquete.ts: 100%
- MemoriaEquipoRepositorio.ts: 87.77%
- CrearEquipo.ts: 91.89%

## Verificación

Para verificar las pruebas localmente:
\`\`\`bash
npm test
...
- **URL del repositorio:** `https://github.com/WilsonRamos/sistema-monitoreo`
- **Rama principal:** `main`
- **Rama del laboratorio:** `feature/lab04-testing`
- **Link directo a la rama:** `https://github.com/WilsonRamos/sistema-monitoreo/feature/lab04-testing`
...
```
PASS Dominio/monitoreo/__tests__/Equipo.test.ts (12.605 s)
  Equipo - Pruebas Unitarias de Dominio
    Constructor e Invariantes
      ✓ Debería crear un equipo válido con datos correctos (23 ms)
      ✓ INVARIANTE: El código no puede estar vacío (49 ms)
      ✓ INVARIANTE: El código debe tener al menos 3 caracteres (2 ms)
      ✓ INVARIANTE: El tipo debe ser válido (4 ms)
      ✓ Debería crear equipo con valores por defecto (11 ms)
    Cambio de Estado
      ✓ Debería cambiar de DISPONIBLE a OPERANDO (1 ms)
      ✓ Debería cambiar de OPERANDO a DISPONIBLE
      ✓ NO debería permitir estado inválido (3 ms)
      ✓ NO debería permitir transición inválida (OPERANDO a INACTIVO) (4 ms)
    ...
    Manejo de Combustible
      ...
      ✓ NO debería permitir consumir cantidad negativa (2 ms)
      ✓ NO debería permitir consumir más combustible del disponible (2 ms)
    ...
    Sistema de Alertas
      ...
      ✓ Debería generar alerta por bajo nivel de combustible
      ✓ Debería generar alerta por exceso de horas de operación
      ✓ Debería generar alerta por equipo en MANTENIMIENTO (4 ms)
      ✓ NO debería generar alertas si todo está bien (1 ms)
    Comportamientos del Dominio
      ✓ puedeOperar() debería retornar true solo si está DISPONIBLE (2 ms)
      ✓ reiniciar() debería restaurar valores iniciales
      ✓ obtenerInfo() debería retornar todos los datos del equipo (2 ms)
    ...
    Tipos de Equipos Válidos
      ✓ Debería crear VOLQUETE
      ✓ Debería crear EXCAVADORA
      ✓ Debería crear BULLDOZER (1 ms)
      ✓ Debería crear GRUA
      ✓ Debería crear PERFORADORA

PASS Dominio/monitoreo/__tests__/Excavadora.test.ts (12.753 s)
  Excavadora - Pruebas Unitarias de Dominio
    Constructor y Herencia
      ✓ Debería crear una excavadora con tipo correcto (16 ms)
    ...
    Comportamiento específico: excavar()
      ...
      ✓ NO debería poder excavar cuando NO está OPERANDO (21 ms)
      ✓ NO debería poder excavar en MANTENIMIENTO (2 ms)
...
PASS Dominio/monitoreo/__tests__/Volquete.test.ts (12.877 s)
  Volquete - Pruebas Unitarias de Dominio
    Constructor y Herencia
      ✓ Debería crear un volquete con tipo correcto (12 ms)
      ✓ Debería heredar propiedades de Equipo (2 ms)
      ✓ Debería heredar comportamientos de Equipo (1 ms)
    Comportamiento específico: transportar()
      ✓ Debería poder transportar cuando está OPERANDO (2 ms)
      ✓ NO debería poder transportar cuando NO está OPERANDO (14 ms)
      ✓ NO debería poder transportar en MANTENIMIENTO (2 ms)
    Integración con funcionalidades heredadas
      ✓ Debería consumir combustible al transportar (simulado) (1 ms)
      ✓ Debería sumar horas al transportar (simulado) (1 ms)

PASS infraestructura/persistencia/repositorios/__tests__/MemoriaEquipoRepositorio.integration.test.ts (13.031 s)
  MemoriaEquipoRepositorio - Pruebas de Integración
    Creación
      ✓ Debería crear un equipo correctamente (15 ms)
      ✓ NO debería permitir crear equipos con código duplicado (8 ms)
      ✓ Debería permitir crear múltiples equipos con códigos diferentes (10 ms)
    Lectura
      ...
      ✓ Debería retornar array vacío si no hay equipos (2 ms)
    Actualización
      ✓ Debería actualizar un equipo existente (4 ms)
      ✓ NO debería actualizar un equipo inexistente (2 ms)
    Eliminación
      ✓ Debería eliminar un equipo existente (3 ms)
      ✓ NO debería eliminar un equipo inexistente (1 ms)
      ✓ Debería reducir el total de equipos al eliminar (4 ms)
    Búsquedas específicas
      ✓ Debería encontrar todos los equipos de tipo VOLQUETE (5 ms)
      ✓ Debería retornar array vacío si no hay equipos del tipo (2 ms)
      ✓ Debería encontrar todos los equipos DISPONIBLES (7 ms)
      ✓ Debería encontrar equipos en MANTENIMIENTO (3 ms)
      ✓ Debería retornar true si existe un equipo con el código (2 ms)
      ✓ Debería retornar false si NO existe (1 ms)
    Integridad
      ✓ Debería preservar todos los datos del equipo (4 ms)
      ✓ Debería retornar copias independientes (2 ms)
    Estadísticas
      ✓ Debería generar estadísticas correctas (5 ms)

PASS aplicacion/casos-uso/equipos/__tests__/CrearEquipo.integration.test.ts (13.061 s)
  CrearEquipo - Pruebas de Integración con Mocks
    Caso exitoso
      ✓ Debería crear un equipo válido usando el repositorio (108 ms)
      ✓ Debería crear equipo con valores iniciales correctos (11 ms)
    Validaciones de negocio
      ✓ NO debería crear equipo con código duplicado (38 ms)
      ✓ NO debería crear equipo con código vacío (19 ms)
      ✓ NO debería crear equipo con tipo inválido (13 ms)
      ✓ NO debería crear equipo con combustible negativo (11 ms)
      ✓ NO debería crear equipo con horas negativas (8 ms)
    Manejo de errores del repositorio
      ✓ Debería propagar errores del repositorio al verificar existencia (10 ms)
      ✓ Debería propagar errores del repositorio al crear (10 ms)
    Verificación de comportamiento (interacciones)
      ✓ Debería verificar existencia ANTES de crear (21 ms)
      ✓ NO debería llamar a otros métodos del repositorio (7 ms)
    Pruebas paramétricas con diferentes tipos de equipos
      ✓ Debería crear equipo de tipo VOLQUETE (10 ms)
      ✓ Debería crear equipo de tipo EXCAVADORA (17 ms)
      ✓ Debería crear equipo de tipo BULLDOZER (12 ms)
      ✓ Debería crear equipo de tipo GRUA (11 ms)
      ✓ Debería crear equipo de tipo PERFORADORA (10 ms)
...
| **Snapshots**              | 0       | N/A             |
| **Tiempo de ejecución**    | 13.227s | ✅ Aceptable    |
...
| --------------- | -------------------------------------------- | -------- | --------- | ----------- |
| **Unitarias**   | Equipo.test.ts                               | 34       | 12.6s     | ✅ PASS     |
| **Unitarias**   | Excavadora.test.ts                           | 8        | 12.7s     | ✅ PASS     |
| **Unitarias**   | Volquete.test.ts                             | 8        | 12.8s     | ✅ PASS     |
| **Integración** | MemoriaEquipoRepositorio.integration.test.ts | 24       | 13.0s     | ✅ PASS     |
| **Integración** | CrearEquipo.integration.test.ts              | 16       | 13.1s     | ✅ PASS     |
| **TOTAL**       |                                              | **82**   | **13.2s** | **✅ 100%** |
...
- Pruebas de integración: 10-20 ms
- Ejemplo: "NO debería permitir crear código duplicado" - 8ms

**Pruebas más lentas:**

- Pruebas con múltiples mocks: 50-150 ms
- Ejemplo: "Debería crear equipo válido usando repositorio" - 108ms

**Tiempo promedio por prueba:** 161ms (13227ms / 82 tests)
...
- ⚠️ Líneas no cubiertas:
  - Validaciones de formato (94, 99, 104) ya cubiertas por el dominio
...
#### **Captura 1: Resumen Global**

Ubicación: Console después de `npm run test:coverage`
Debe mostrar:
...
#### **Captura 2: Reporte HTML - Vista General**

Ubicación: `coverage/lcov-report/index.html`
Debe mostrar: Listado de archivos con barras verdes >90%

#### **Captura 3: Reporte HTML - Detalle de Equipo.ts**

Debe mostrar: Código con líneas verdes (cubiertas)

#### **Captura 4: Reporte HTML - Detalle de MemoriaEquipoRepositorio.ts**

Debe mostrar: Código con alta cobertura
